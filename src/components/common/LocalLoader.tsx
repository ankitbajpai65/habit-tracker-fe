    ...
    <>
      {props.status && (
        <div
          ...
          className={`inline-block text-medswan-200 animate-spin rounded-full border-4 border-solid border-current border-r-transparent align-[-0.125em] motion-reduce:animate-[spin_1.5s_linear_infinite] ${props.style}`}
